...
export default function Invoices() {
  ...
  <DialogContent className="invoice-dialog max-w-4xl p-0 overflow-hidden">

    <DialogHeader className="no-print px-6 py-4 border-b flex-shrink-0">
    ...
    {inv && (
      <div className="invoice-scroll overflow-y-auto max-h-[78vh]">
        <div
          className="print-area bg-white text-black p-8"
        ...
        >
          ...
          <div className="flex justify-between items-start border-b-2 border-yellow-600 pb-4">
            <div>
              ...
              >
                {inv.settings?.business_name || "GrandImperia Banquets"}
              </div>

              <div className="text-sm text-gray-600">
                {inv.settings?.address}
              </div>

              <div className="text-sm text-gray-600">
                {inv.settings?.phone} · {inv.settings?.email}
              </div>

              {inv.settings?.gstin && (
                <div className="text-sm text-gray-600">
                  GSTIN: {inv.settings.gstin}
                </div>
              )}
            </div>
          ...
          <div className="grid grid-cols-2 gap-6 mt-6 text-sm">
            ...
            <div>
              ...
              <div className="text-gray-600">
                {inv.customer?.address}, {inv.customer?.city}
              </div>

              {inv.customer?.gst_number && (
                <div>
                  GSTIN: {inv.customer.gst_number}
                </div>
              )}
            </div>
            ...
            <div className="text-right">
              ...
              <div className="font-semibold">
                {inv.booking?.event_name || inv.booking?.event_type}
              </div>
              ...
              <div>
                Date: {inv.booking?.event_date} ·{" "}
                {inv.booking?.start_time}–{inv.booking?.end_time}
              </div>

              <div>
                Guests: {inv.booking?.guest_count}
              </div>

              <div>
                Booking: {inv.booking?.booking_number}
              </div>
            </div>
            ...
            <tbody>
              ...
              <tr>
                <td className="p-2 border-t">
                  Hall Charges — {inv.hall?.name}
                </td>
                <td className="p-2 border-t text-right">
                  {fmtINR(inv.booking?.hall_charges)}
                </td>
              </tr>
              ...
              <tr>
                ...
                <td className="p-2 border-t text-right">
                  {fmtINR(inv.booking?.package_charges)}
                </td>
              </tr>
              ...
              <tr>
                ...
                <td className="p-2 border-t text-right">
                  {fmtINR(inv.booking?.food_charges)}
                </td>
              </tr>
              ...
              <tr>
                ...
                <td className="p-2 border-t text-right">
                  {fmtINR(inv.booking?.decoration_charges)}
                </td>
              </tr>
              ...
              <tr>
                ...
                <td className="p-2 border-t text-right">
                  {fmtINR(inv.booking?.additional_charges)}
                </td>
              </tr>
              ...
              <tr>
                ...
                <td className="p-2 border-t text-right font-semibold">
                  {fmtINR(inv.subtotal)}
                </td>
              </tr>
              ...
              <tr>
                <td className="p-2 border-t text-green-700">
                  Paid
                </td>
                <td className="p-2 border-t text-right text-green-700">
                  {fmtINR(inv.paid_amount)}
                </td>
              </tr>

              <tr>
                <td className="p-2 border-t text-red-600 font-semibold">
                  Balance Due
                </td>
                <td className="p-2 border-t text-right text-red-600 font-semibold">
                  {fmtINR(inv.due_amount)}
                </td>
              </tr>
          ...
          <div className="mt-8 flex justify-between text-xs text-gray-500 pb-8">
            <div>
              Payment Terms: Balance due before event date.
              <br />
              Thank you for choosing GrandImperia.
            </div>

            <div className="text-right">
              <div className="mt-8 border-t border-gray-400 pt-1 w-40 ml-auto">
